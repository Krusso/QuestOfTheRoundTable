...
public class TestA1 {
	...
	public void doIParticipateInTournament() {
		...
		AbstractAI player = new A1(new Player(0, new UIPlayer("", "")), pm, new BoardModelMediator(null, null, null));
		pm.nextTurn();
		...
		player = new A1(p1, pm, new BoardModelMediator(null, null, null));
		assertEquals(false, player.doIParticipateInTournament());
	...
	public void playCardsForTournament() {
		...
		AbstractAI player = new A1(p1, pm, new BoardModelMediator(new TournamentModel(), null, null));
		assertEquals(true, TestA2.compare(player.playCardsForTournament(),  new String[] {}));
		
		p1 = new Player(0, new UIPlayer("", ""));
		p1.hand.addCard(new WeaponCard("Excalibur",30, TYPE.WEAPONS));
		p1.hand.addCard(new WeaponCard("Excalibur",30, TYPE.WEAPONS));
		player = new A1(p1, pm, new BoardModelMediator(new TournamentModel(), null, null));
	...
	public void doIParticipateInQuest() {
		...
		p1.hand.addCard(new WeaponCard("Excalibur",30, TYPE.WEAPONS));
		p1.hand.addCard(new WeaponCard("Lance",20, TYPE.WEAPONS));
		AbstractAI player = new A1(p1, null, new BoardModelMediator(null, null, null));
		...
		p1.hand.addCard(new WeaponCard("Lance",20, TYPE.WEAPONS));
		p1.hand.addCard(new WeaponCard("Lance",20, TYPE.WEAPONS));
		player = new A1(p1, null, new BoardModelMediator(null, null, null));
		assertEquals(false, player.doIParticipateInQuest(new QuestCard("Repel the Saxon Raiders",2,new String[] {"Saxons", "Saxon Knight"})));
