...
public class TestA3 {
	...
	public void doIParticipateInTournament() {
		...
		AbstractAI player = new A3(new Player(0, new UIPlayer("", "")), pm, new BoardModelMediator(new TournamentModel(false), null, null, null, null, null));
		pm.players[0] = p1;
		pm.players[1] = p2;
	...
	public void doIParticipateInQuest() {
		...
		AbstractAI player = new A3(p1, pm, new BoardModelMediator(null, tm, null, null, null, null));
		...
		player = new A3(p1, pm, new BoardModelMediator(null, tm, null, null, null, null));
		assertEquals(true, player.doIParticipateInQuest(new QuestCard("Search for the Holy Grail",5,new String[] {"All", "Sir Percival"})));
