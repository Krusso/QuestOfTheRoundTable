...
public class TestA3 {
	...
	public void doIParticipateInTournament() {
		...
		AbstractAI player = new A3(new Player(0, new UIPlayer("", "")), pm, new BoardModelMediator(new TournamentModel(), null, null, null, null));
		pm.players[0] = p1;
		pm.players[1] = p2;
	...
	public void playCardsForTournament() {
		...
		AbstractAI player = new A3(p1, pm, new BoardModelMediator(tm, null, null, null, null));
		...
		player = new A3(p1, pm, new BoardModelMediator(tm, null, null, null, null));
	...
	public void doISponserAQuest() {
		...
		p1.hand.addCard(new WeaponCard("Excalibur",30, TYPE.WEAPONS));
		p1.hand.addCard(new WeaponCard("Lance",20, TYPE.WEAPONS));
		AbstractAI player = new A3(p1, pm, new BoardModelMediator(new TournamentModel(), null, null, null, null));
		...
		player = new A3(p1, pm, new BoardModelMediator(new TournamentModel(), null, null, null, null));
		assertEquals(null, player.doISponsorAQuest(new QuestCard("Repel the Saxon Raiders",2,new String[] {"Saxons", "Saxon Knight"})));
	...
	public void doIParticipateInQuest() {
		...
		AbstractAI player = new A3(p1, pm, new BoardModelMediator(null, tm, null, null, null));
		...
		player = new A3(p1, pm, new BoardModelMediator(null, tm, null, null, null));
		assertEquals(true, player.doIParticipateInQuest(new QuestCard("Search for the Holy Grail",5,new String[] {"All", "Sir Percival"})));
