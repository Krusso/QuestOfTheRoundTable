function clearShieldSelect() {
    for (var i = 1; i < 5; i++) {
        document.getElementById("shield" + i).classList.remove('selectedShield');
    }
}

function selectShield(num) {
    clearShieldSelect();
    document.getElementById("shield" + num).classList.add('selectedShield');
}
